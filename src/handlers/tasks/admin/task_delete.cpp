...
namespace tms::handlers::tasks::admin::del
{

DeleteTaskHandler::DeleteTaskHandler(const userver::components::ComponentConfig& config,
...
userver::formats::json::Value DeleteTaskHandler::HandleRequestJsonThrow(const userver::server::http::HttpRequest& request,
